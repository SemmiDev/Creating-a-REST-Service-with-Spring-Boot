...
import com.sammidev.belajar.controller.StudentController;
...
public class StudentControllerTest {
    ...
    Course mockCourse2 = new Course("Course2", "Spring MVC", "10 Examples",
            Arrays.asList("Learn Maven", "Import Project", "First Example", "Second Example"));

    String exampleCourseJson = "{\"name\":\"Spring\",\"description\":\"10Steps\",\"steps\":[\"Learn Maven\",\"Import Project\",\"First Example\",\"Second Example\"]}";
    String exampleCourseJson2 = "{\"name\":\"Spring MVC\",\"description\":\"10 Examples\",\"steps\":[\"Learn Maven\",\"Import Project\",\"First Example\",\"Second Example\"]}";
